...
\texttt{Sigmoid<T>} is a \href{\kmlroot/reference/kernel.html}{Kernel}. If k is an object of class \texttt{sigmoid<T>}, and u and v are objects of class T, then k(u,v) returns
%
...
Defined in the KML header \href{\kmlsvnroot/kml/sigmoid.hpp}{kml/sigmoid.hpp}.
